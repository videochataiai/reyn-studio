/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 72d5609c12bf713a6528a805228e8c19)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	AUTH_EVENTS: KVNamespace;
	...
	YC_USERNAME: string;
	YC_PASSWORD_DIGEST_HEX: string;
	AUTH_PEPPER: string;
	EVENT_HASH_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TERMS_VERSION" | "PRIVACY_VERSION" | "SESSION_TTL_SECONDS" | "EVENT_RETENTION_SECONDS" | "YC_USERNAME" | "YC_PASSWORD_DIGEST_HEX" | "AUTH_PEPPER" | "EVENT_HASH_KEY">> {}
}
